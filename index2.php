  ...
  <section class="container my-3">
    <div class="row">
      <div class="row">
        <div class="col-8">
          <div class="input-group rounded">
            <input autocomplete="off" id="busca" type="search" class="form-control rounded" placeholder="Pesquisar" aria-label="Search" aria-describedby="search-addon" />
      ...
      <div class="col-sm-8" id="resultado">
        <h2 id="tam">Posts - Total de:<span style="color:#198754"> <?=sizeof($lista) ?> publicações</span></h2>
      ...
      <div class="col-sm-4">
        ...
        <h4 class="py-2 my-0 px-2 bg-light">Tags</h4>
        <div class="divider-1"></div>
        <div class="list-group my-2">
