                                ...
                                <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">
                                    <div class="faixa">
                                        <ul>
                                            ...
                                            <li style="background-color:#d3d3d3; border-radius:0.2rem;">
                                                <a class="mx-1" href="#collapseExample" style="font-size: 0.8rem;" data-toggle="collapse" href="#collapseExample<?=$count?>" aria-expanded="false" aria-controls="collpaseExample<?=$count?>" style="background-color:#d3d3d3; font-size:14px" type="button"><i class="fas fa-trash-alt"></i>deletar</a>
                                            ...
                                            <div class="collapse" id="collapseExample">
                                                    <div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col">
                                                                <a href="deletar-postagem.php?id=<?=$postId;?>"><i style="color:green" class="fas fa-check"></i></a>

                                                            </div>
                                                            <div class="col">
                                                                <a data-toggle="collapse" href="#collapseExample" aria-expanded="false" aria-controls="collpaseExample" type="button"><i style="color:red" class="fas fa-times"></i></a>
